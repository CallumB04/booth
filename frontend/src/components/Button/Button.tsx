...
const Button = ({
    ...
    return (
        <button
            className={twMerge(
                "flex h-11 items-center justify-center gap-2 rounded-md px-5 font-sans text-[13px] font-medium tracking-wide uppercase transition-all active:translate-y-px",
                variant === "primary" &&
                    (disabled
